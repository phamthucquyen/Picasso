...
public class Pixmap {
	...
	public static final String DEFAULT_NAME = "Picasso: Dynamos";
	...
	public void read(String fileName) {
		try {
			...
			ErrorHandler.getInstance().errorMessage(e, "Invalid File Type!");
			createImage(Main.SIZE.width, Main.SIZE.height, DEFAULT_COLOR);
